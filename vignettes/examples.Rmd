...
with some of the arguments in the function to make the plots more pleasing, 
...
coords <- data.frame(lat = c(-23, -24), lon = c(150, 151))
ggplot() +
...
Finally, you can also crop a particular dataset for a user-defined region
