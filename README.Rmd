...
[![R build status](https://github.com/dbarneche/gisaimsr/workflows/R-CMD-check/badge.svg)](https://github.com/dbarneche/gisaimsr/actions)
...
Files are Our 
This R package is provided for use under the MIT License ([MIT](http://opensource.org/licenses/MIT)) by the [Australian Institute of Marine Science](https://www.aims.gov.au).
